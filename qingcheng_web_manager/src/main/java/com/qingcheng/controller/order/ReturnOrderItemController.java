...
public class ReturnOrderItemController {
    ...
    @GetMapping("/findByReturnOrderId")
    public List<ReturnOrderItem> findByReturnOrderId(String id){
        List<ReturnOrderItem> returnOrderItemList = this.returnOrderItemService.findByReturnOrderId(id);
