...
public class TemplateServiceImpl implements TemplateService {
    ...
    public void add(Template template) {
        template.setSpecNum(0); // 设置初始值
        template.setParaNum(0); // 设置初始值
    ...
    public void delete(Integer id) {
        ...
        HashMap<String, Object> searchMap = new HashMap<String, Object>(); // 设置map条件
        searchMap.put("templateId",id);
        this.specService.deleteList(searchMap); // 删除spec表中的数据
        this.paraService.deleteList(searchMap); // 删除para表中的数据
